...
public:
   ...
   /// Retrieve the server object.  Valid only on a local connection.
...
#define TNL_IMPLEMENT_NETOBJECT(className) \
   ...
   TNL::ClassRepInstance<className> className::dynClassRep(#className, TNL::NetClassGroupGameMask, TNL::NetClassTypeObject, 0)
...
public: \
   ...
   TORQUE_DECLARE_CLASS( RPCEV_##className##_##name ); \
