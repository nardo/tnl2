...
inline void read(BitStream &stream, Nonce *theNonce)
{ 
   stream.read(Nonce::NonceSize, theNonce->data);
}

inline void write(BitStream &stream, const Nonce &theNonce)
{
   stream.write(Nonce::NonceSize, theNonce.data);
}
