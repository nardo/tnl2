...
void ConnectionStringTable::write(BitStream &stream, const StringTableEntry &string)
{
...
void ConnectionStringTable::read(BitStream &stream, StringTableEntry *theEntry)
{
...
void ConnectionStringTable::packetReceived(PacketList *note)
{
   ...
   while(walk)
   {
      ...
      packetEntryFreeList.freeElem(walk);
      walk = next;
   }
}
