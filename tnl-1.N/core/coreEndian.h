...
//------------------------------------------------------------------------------
// Endian conversions
#if defined(TORQUE_LITTLE_ENDIAN)
...
DECLARE_TEMPLATIZED_ENDIAN_CONV(U8)
DECLARE_TEMPLATIZED_ENDIAN_CONV(S8)
DECLARE_TEMPLATIZED_ENDIAN_CONV(U16)
DECLARE_TEMPLATIZED_ENDIAN_CONV(S16)
DECLARE_TEMPLATIZED_ENDIAN_CONV(U32)
DECLARE_TEMPLATIZED_ENDIAN_CONV(S32)
DECLARE_TEMPLATIZED_ENDIAN_CONV(U64)
DECLARE_TEMPLATIZED_ENDIAN_CONV(S64)
DECLARE_TEMPLATIZED_ENDIAN_CONV(F32)
DECLARE_TEMPLATIZED_ENDIAN_CONV(F64)

#undef DECLARE_TEMPLATIZED_ENDIAN_CONV
