...
/// the base types that can be transmitted using Torque's RPC mechanism.
...
/// counts or numeric ranges is necessary because the overloaded read
/// and write functions use these parameters for bit counts in the
/// BitStream read and writes.
struct NetType {
...
#define TORQUE_COMPILER_STRING "Metrowerks CW Win32"
...
#else
#  error "Torque: Unsupported Operating System"
#endif
...
#    define TORQUE_SUPPORTS_MWERKS_INLINE_X86_ASM
#  else
...
#  ifdef __GNUC__
#    define TORQUE_SUPPORTS_GCC_INLINE_PPC_ASM
#  endif
#else
#  error "Torque: Unsupported Target CPU"
#endif
