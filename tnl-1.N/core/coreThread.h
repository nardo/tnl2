...
/// methods declared with the DECLARE_THREADQ_METHOD macro
...
class ThreadQueue : public Object
{
   ...
   Vector<Functor<BitStream> *> mThreadCalls;
   /// list of calls to be processed by the main thread
   Vector<Functor<BitStream> *> mResponseCalls;
...
protected:
   ...
   void postCall(Functor<BitStream> *theCall);
...
#define IMPLEMENT_THREADQ_METHOD(className, func, args, argNames) \
   ...
   TNL::FunctorDecl<TNL::BitStream, void (className::*)args> *theCall = new TNL::FunctorDecl<BitStream, void (className::*)args>(&className::func##_body); \
