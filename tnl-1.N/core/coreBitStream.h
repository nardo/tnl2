...
#ifndef _CORE_BYTEBUFFER_H_
#include "core/coreByteBuffer.h"
#endif
...
/// StringTableEntryCompressor assist the BitStream by compressing StringTableEntry instances into the BitStream.
class StringTableEntryCompressor
{
public:
   virtual void read(BitStream &theStream, StringTableEntry *theEntry) = 0;
   virtual void write(BitStream &theStream, const StringTableEntry &theEntry) = 0;
};
...
protected:
   ...
   StringTableEntryCompressor *mSTECompressor; ///< Object that helps compress StringTableEntry instances into the BitStream.  NULL by default.
...
public:
   ...
   /// sets the StringTableEntryCompressor for this BitStream
   void setStringTableEntryCompressor(StringTableEntryCompressor *com) { mSTECompressor = com; }

   /// returns the StringTableEntryCompressor for this BitStream
   StringTableEntryCompressor *getStringTableEntryCompressor() { return mSTECompressor; }
...
{
   Assert(value >= rangeStart && value <= rangeEnd, "Out of bounds value!");
   Assert(rangeEnd >= rangeStart, "error, end of range less than start");
